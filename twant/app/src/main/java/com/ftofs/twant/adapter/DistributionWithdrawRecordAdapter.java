...
public class DistributionWithdrawRecordAdapter extends BaseMultiItemQuickAdapter<DistributionWithdrawRecord, BaseViewHolder> {
    Context context;
    int gray;
    int blue;
    int red;

    public DistributionWithdrawRecordAdapter(Context context, @Nullable List<DistributionWithdrawRecord> data) {
        super(data);
        ...
        addItemType(Constant.ITEM_TYPE_NORMAL, R.layout.distribution_withdraw_record);
