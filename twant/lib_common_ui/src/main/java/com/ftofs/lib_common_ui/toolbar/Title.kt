...
class ContextTitle @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, @AttrRes defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr)
{
    ...
    val leftImgView by lazy {
        ImageView(context).apply {
            ...
            setPadding(Util.dip2px(context, 15f), 0, Util.dip2px(context, 15f), 0)
    ...
    private val leftTextview by lazy {
        TextView(context).apply {
            layoutParams = LinearLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.MATCH_PARENT).apply {
                setMargins(Util.dip2px(context, 8f), Util.dip2px(context, 0f), Util.dip2px(context, -8f), Util.dip2px(context, 0f))
            }
            text = leftText
    ...
    private val titleTextview by lazy {
        TitleTextView(context).apply {
            ...
            if (titleRightImg > -1)
            {
                ...
                compoundDrawablePadding = Util.dip2px(context, 5f)
            }
        }
    }
    ...
    private val lineView by lazy {
        View(context).apply {
            layoutParams = LinearLayout.LayoutParams(Util.dip2px(context, 0f), Util.dip2px(context, 1f), 1f)
        }
    }
...
//                    layoutparams.height = layoutparams.height + StateBarUtil.ContextTitle_titleScrllo(context)
...
//                            this@ContextTitle.paddingBottom)
    ...
    fun setTitleRightImg(@DrawableRes titleRightImg: Int)
    {
        ...
        if (titleRightImg > -1)
        {
            ...
            titleTextview.compoundDrawablePadding = Util.dip2px(context, 5f)
        }
    }
