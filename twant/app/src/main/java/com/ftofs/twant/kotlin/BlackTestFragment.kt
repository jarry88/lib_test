...
//                }
    ...
    override fun initData() {
        binding.button1.apply {
            ...
            setOnClickListener {
                viewModel.getData()
                com.ftofs.twant.util.Util.startFragment(CouponPayResultFragment.newInstance(4129,success = false))
        ...
        binding.button2.apply {
            ...
            setOnClickListener {
                ...
                KLog.init(true)
                com.ftofs.twant.util.Util.startFragment(CouponPayResultFragment.newInstance(4129,success = true))
