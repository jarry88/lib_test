...
public class ImStoreOrderPopup extends BottomPopupView implements View.OnClickListener {
    ...
    public ImStoreOrderPopup(@NonNull Context context, PopupType popupType, String imName, OnSelectedListener onSelectedListener) {
        super(context);
    ...
    private void loadData() {
        ...
        Api.postUI(Api.PATH_IM_STORE_ORDER_LIST, params, new UICallback() {
            @Override
