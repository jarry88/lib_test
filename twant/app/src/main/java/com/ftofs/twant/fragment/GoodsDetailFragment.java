                ...
                try {
                    ...
                    for (Object object : easyJSONArray) {
                        ...
                        if (goodsMobileBodyVo.getType().equals("image")) {
                            ...
                            Glide.with(llGoodsDetailImageContainer).load(imageUrl).apply(RequestOptions.bitmapTransform(new RoundedCorners(0))).override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL).into(imageView);
