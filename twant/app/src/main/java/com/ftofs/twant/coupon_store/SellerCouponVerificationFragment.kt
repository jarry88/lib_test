...
class SellerCouponVerificationFragment: BaseTwantFragmentMVVM<CouponActivityListFragmentBinding,CouponStoreViewModel>(){
    ...
    companion object{
        @JvmStatic
        fun newInstance()=SellerCouponVerificationFragment().apply{
