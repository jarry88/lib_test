 ...
 * https://juejin.im/post/5a7eb8005188257a642693b3
 */
...
//            // 获取当前页面窗口的显示范围
            ...
            SLog.info("mIsKeyboardActive[%s], mKeyboardHeight[%s], screenHeight[%s]",
                    mIsKeyboardActive, mKeyboardHeight, screenHeight);
            if (mListener != null) {
